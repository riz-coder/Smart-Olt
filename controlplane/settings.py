...
SESSION_COOKIE_SECURE = _env_bool("CONTROL_SESSION_COOKIE_SECURE", False)
CSRF_COOKIE_SECURE = _env_bool("CONTROL_CSRF_COOKIE_SECURE", False)
SECURE_SSL_REDIRECT = _env_bool("CONTROL_SECURE_SSL_REDIRECT", False)
