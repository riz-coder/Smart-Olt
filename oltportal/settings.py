...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'oltmanager.context_processors.expiring_olt_subscriptions',
            ],
        },
    },
]
...
OLT_ONU_OPTICAL_STALE_AFTER_SECONDS = int(os.environ.get('OLT_ONU_OPTICAL_STALE_AFTER_SECONDS', '21600'))
OLT_ONU_SIGNAL_SINGLE_RETRY_LIMIT = int(os.environ.get('OLT_ONU_SIGNAL_SINGLE_RETRY_LIMIT', '120'))
