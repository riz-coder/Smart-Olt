...
class OLTForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.pk:
            ...
            self.fields['snmp_mode'].initial = 'generate'
            self.fields['snmp_community'].initial = self._build_snmp_read_default()
            self.fields['snmp_write_community'].initial = self._build_snmp_write_default()
