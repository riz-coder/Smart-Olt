...
urlpatterns = [
    ...
    path('configured/<int:olt_pk>/<int:slot>/<int:port>/<int:ont_id>/distance-refresh/', views.configured_onu_distance_refresh, name='configured_onu_distance_refresh'),
    ...
    path('settings/vpn/', views.settings_vpn, name='settings_vpn'),
    path('settings/vpn/download/', views.settings_vpn_download, name='settings_vpn_download'),
    ...
    path('settings/tenants/', views.settings_tenants, name='settings_tenants'),
    ...
    path('view/<int:pk>/vlan-description/', views.olt_update_vlan_description, name='olt_update_vlan_description'),
    path('view/<int:pk>/uplink-description/', views.olt_update_uplink_description, name='olt_update_uplink_description'),
