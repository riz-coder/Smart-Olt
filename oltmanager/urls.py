...
urlpatterns = [
    ...
    path('control/clients/', views.control_clients, name='control_clients'),
    path('control/clients/<int:pk>/', views.control_client_detail, name='control_client_detail'),
    path('control/users/', views.control_users, name='control_users'),
    path('control/olts/', views.control_olts, name='control_olts'),
    path('control/plans/', views.control_plans, name='control_plans'),
