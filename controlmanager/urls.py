...
urlpatterns = [
    ...
    path("tenants/<int:pk>/vpn/download/", views.tenant_vpn_download, name="control_tenant_vpn_download"),
    path("tenants/<int:pk>/vpn/status/", views.tenant_vpn_status, name="control_tenant_vpn_status"),
