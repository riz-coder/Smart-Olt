...
class Tenant(models.Model):
    ...
    database_engine = models.CharField(max_length=16, default='postgresql', choices=[('postgresql', 'PostgreSQL')])
    database_name = models.CharField(max_length=63, blank=True, default='')
    database_user = models.CharField(max_length=63, blank=True, default='')
    database_password = models.CharField(max_length=160, blank=True, default='')
    database_host = models.CharField(max_length=160, default='127.0.0.1')
    ...
    client_public_ip = models.GenericIPAddressField(blank=True, null=True)
    client_vpn_port = models.PositiveIntegerField(default=51820)
    client_local_subnet = models.CharField(max_length=64, blank=True, default="")
    olt_management_subnet = models.CharField(max_length=64, blank=True, default="")
    wg_server_endpoint = models.CharField(max_length=160, blank=True, default="")
